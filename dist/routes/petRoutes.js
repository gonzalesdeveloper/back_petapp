...
class PetRoutes {
    ...
    config() {
        ...
        this.routes.get('/listadoption/:IdPersona', petController_1.petController.listPetAdoption);
        this.routes.get('/listmyadoption/:IdPersona', petController_1.petController.listMyAdoptions);
